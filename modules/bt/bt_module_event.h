...
enum bt_module_event_error_codes {
  BT_EVT_ERR_ADV_FAILED,
  BT_EVT_ERR_SECURITY_FAILED,
  BT_EVT_ERR_HEATY_INIT_FAILED,
  BT_EVT_ERR_CAMERA_INIT_FAILED,
  BT_EVT_ERR_TIME_INIT_FAILED,
  BT_EVT_ERR_BRIDGE_INIT_FAILED,
  BT_EVT_ERR_BT_NUS_INIT_FAILED,
  BT_EVT_ERR_BASE64_FAILED,
  BT_EVT_ERR_SEND_FAILED
};
