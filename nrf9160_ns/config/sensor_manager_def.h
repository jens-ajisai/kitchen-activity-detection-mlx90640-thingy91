/*
 * This code is based on the machine_learning which has the below license
 * nrf/applications/machine_learning/configuration
 * 
 ...
 */
const struct {
} sensor_manager_def_include_once;
    ...
    .activation = {.type = ACT_TYPE_ABS,
                   .thresh = CONFIG_ADXL362_ACTIVITY_THRESHOLD *
                             (IS_ENABLED(CONFIG_ADXL362_ACCEL_RANGE_8G)   ? 8.0
                              ...
                              : IS_ENABLED(CONFIG_ADXL362_ACCEL_RANGE_2G) ? 2.0
                                                                          : 1 / 0) /
                             2048.0,
                   .timeout_ms = 10 * 1000}};
*/
...
static const struct sm_sampled_channel env_chan[] = {
    {
...
static const struct sm_sampled_channel color_chan[] = {
    {
