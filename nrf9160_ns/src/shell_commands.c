...
static int memfault_send_data_test(const struct shell *shell, size_t argc, char **argv) {
  ...
  while (retrieve_memfault_data_as_base64(&memfaultData)) {
    if (memfaultData) {
      ...
      uint8_t *decoded_data = my_malloc(decoded_data_size, HEAP_MEMORY_STATISTICS_ID_SHELL_HEATMAP_DATA);
...
static const char* mock_heatMapData = "{\"type\":1,\"data\":\"\",\"len\":1536}";

static int test_mcuExchange_message_heatMapData(const struct shell *shell, size_t argc, char **argv) {
    struct mcu_exchange_module_event *event = new_mcu_exchange_module_event(strlen(mock_heatMapData) + 1);
...
SHELL_STATIC_SUBCMD_SET_CREATE(
    ...
    SHELL_CMD(t, NULL, "Log hello", test_mcuExchange_message_heatMapData),
    SHELL_CMD(get_memory_stats, NULL, "Get allocation leftovers", get_memory_stats),
    SHELL_CMD(test_led, NULL, "test led", test_led), SHELL_SUBCMD_SET_END /* Array terminated. */
);
