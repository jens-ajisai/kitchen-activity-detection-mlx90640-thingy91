...
HEATMAP_SERVICE_UUID = "aaaf0a00-c332-42a8-93bd-25e905756cb8"
HEATMAP_RX_UUID      = "aaaf0a01-c332-42a8-93bd-25e905756cb8"
HEATMAP_TX_UUID      = "aaaf0a02-c332-42a8-93bd-25e905756cb8"
HEATY_SERVICE_UUID   = "aaaf0900-c332-42a8-93bd-25e905756cb8"
...
async def main():
    ...
    def process_image_data(img_data):
        ...
        jsonData = json.loads(img_data)
        decoded_data = base64.decodebytes(jsonData["data"].encode('ascii'))
        U = struct.unpack("768H", decoded_data)
        newList = [(int) (x / 10) for x in U]
...
#            data = data.replace(b"\r", b"\r\n")
            ...
            await client.write_gatt_char(HEATMAP_RX_UUID, data)
